...
. $(dirname "$0")/config.sh
sudo iptables -I FORWARD -s 192.168.165.15 -d 192.168.165.16 -p tcp --dport 9999 -j NFQUEUE --queue-num 1
...
# sudo tcpdump -i eth1 host 192.168.165.15 and host 192.168.165.16
# sudo iptables -I FORWARD -s 192.168.165.15 -d 192.168.165.16 -p tcp --dport 9999 -j NFQUEUE --queue-num 1
# sudo iptables -L -v -n --line-numbers
# sudo iptables -S | grep NFQUEUE
# sudo iptables -D 
#  tshark -i eth1 -f "host 192.168.165.15 and host 192.168.165.16 and host 192.168.165.14" -w output.pcap 