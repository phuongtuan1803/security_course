...
# ssh -i ./.vagrant/machines/kali/virtualbox/private_key -p 2200 vagrant@127.0.0.1 "yes | ssh-keygen -q -N '' -f ~/.ssh/id_rsa"
ssh -i ./.vagrant/machines/kali/virtualbox/private_key -p 2200 vagrant@127.0.0.1 "git config --global user.name "phuongtuan" && git config --global user.email "phuongtuan1803@gmail.com""
